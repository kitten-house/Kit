                    ...
                    <Toolbar disableGutters>
                        ...
                        <Box sx={{flexGrow: 0}}>
                            ...
                            >
                                ...
                                <MenuItem key={"Messages"} onClick={handleCloseUserMenu}
                                ...
                                <MenuItem key={"AddYourHome"} onClick={handleCloseUserMenu}
                                          sx={{height: '40px', pl: '20px'}}>
                                    <Typography textAlign="center" fontSize={"14px"}
                ...
                {Array.from(Array(50)).map((_, index) => (
                    <Grid xs={2} sm={4} md={4} key={index}>
                        <Stack>
                            ...
                            <Typography fontSize={"15px"} fontWeight={600}>Brålanda, Sweden</Typography>
                            ...
                            <div style={{display:"flex"}}>
                                <Typography fontSize={"15px"} fontWeight={600}><b>$378</b></Typography>
