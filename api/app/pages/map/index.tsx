...
const App: React.FC = () => {
    ...
    return (
        <div style={{ display: "flex", height: "100%" }}>
            <Wrapper apiKey={"AIzaSyB0sKvno04WblBg5x7poj3qjKGdMFMnz30"}>
                <Map
                    center={center}
                    onClick={onClick}
                    onIdle={onIdle}
...
//     root.render(
//         <GoogleOAuthProvider clientId="895061217340-vckj2gbhjiekphkg5lg3f6eaf1e5c0tv.apps.googleusercontent.com"><App /></GoogleOAuthProvider>);
// });
